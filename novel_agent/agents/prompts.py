...
## 评分JSON
```json
{"continuity":X,"cultivation":X,"spatial":X,"character":X,"foreshadow":X,"plot":X,"writing":X,"rules":X,"knowledge":X,"acquaintance":X,"personality":X,"emotion":X,"overall":X,"verdict":"通过/需修改/需重写"}
```"""
