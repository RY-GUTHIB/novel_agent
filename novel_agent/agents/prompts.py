...
- ⚠️【章末钩子衔接】如果上一章结尾有未解决的钩子（如"家主有请""门外传来声音""他终于要出手了吗"等），本章必须在开头 200 字内交代钩子的后续。绝不能跳过钩子直接开始新场景。具体衔接方式参考"上一章结尾内容"。
...
## 评分JSON
```json
{"continuity":X,"cultivation":X,"spatial":X,"character":X,"foreshadow":X,"plot":X,"writing":X,"rules":X,"knowledge":X,"acquaintance":X,"personality":X,"emotion":X,"comparison":X,"overall":X,"verdict":"通过/需修改/需重写"}
```"""
