    ...
    def _extract_and_save_world_settings(self, content: str, chapter: int):
        ...
        try:
            ...
            json_format_example = json.dumps({
                "characters": [
                    {"name": "人物名", "is_new": True, "updates": {"abilities": ["新功法"], "cultivation": "新修为境界（如：筑基中期）", "relationships": {"他人": "新关系"}, "appearance": "新外貌描述", "status": "新状态", "notes": "备注"}}
                ],
                "world_settings": [
...
""" + content
            ...
            for item in char_items:
                ...
                if is_new:
                    # 新增人物
                    from memory import CharacterProfile
            ...
            for item in ws_items:
                ...
                if key in existing_ws_keys:
                    ...
                    from memory import WorldSetting
            ...
            for item in loc_items:
                ...
                if is_new:
                    from memory import LocationProfile
            ...
            for item in knowledge_items:
                ...
                if not char_name or not knowledge_text:
                    continue
                from memory import CharacterKnowledge
